        ...
        while not finished:
            ...
            for i in range(minlen-1):
                ...
                if enable_neg_samples:
                    ...
                    y = out_idx
                self.current_sessions = self.sessions_arr[iters]
                self.curr_interactions = self.interaction_type[start+i+1]
